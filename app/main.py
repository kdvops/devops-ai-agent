...
LLM_TOOLS = [
    ...
    {"type": "function", "name": "list_services", "description": "Lista Services de un namespace para diagnosticar conectividad.", "parameters": {"type": "object", "properties": {"namespace": {"type": "string"}}, "required": ["namespace"], "additionalProperties": False}, "strict": True},
    {"type": "function", "name": "list_configmaps", "description": "Lista ConfigMaps de un namespace sin revelar sus valores.", "parameters": {"type": "object", "properties": {"namespace": {"type": "string"}}, "required": ["namespace"], "additionalProperties": False}, "strict": True},
    {"type": "function", "name": "get_node", "description": "Obtiene condiciones, capacidad y asignación de un nodo Kubernetes.", "parameters": {"type": "object", "properties": {"name": {"type": "string"}}, "required": ["name"], "additionalProperties": False}, "strict": True},
...
def execute(tool: str, arguments: dict[str, Any], user: str | None = None) -> dict[str, Any]:
    ...
    if tool in {"http_request", "ssh_command", "browser_inspect"}:
        ...
        try:
            ...
            raise HTTPException(502, str(exc)) from exc
    if tool in {"cluster_status", "list_namespaces", "list_pods", "list_events", "list_services", "list_configmaps", "get_node", "get_pod", "get_workload", "get_pod_logs", "rollout_status"}:
